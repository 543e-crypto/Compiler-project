...
# to run this script:
#   - make sure you have the Java class p3_java.class
...
echo " - Identifiers type report stored as test$1.out"
java p3_java <$INDIR/test$1.my >$OUTDIR/test$1.out 2>$OUTDIR/test$1.err
echo "--------------------------------------------------"
...
java p3_java <$INDIR/error$1.my >/dev/null 2>$OUTDIR/error$1.err
